...
from leonardo.module.media.models import Folder, File, Image
...
class Category(MPTTModel, TranslatedObjectMixin):
    ...
    logo = models.ForeignKey(Image, blank=True, null=True, verbose_name=_("logo"))
...
class AttributeOption(models.Model, TranslatedObjectMixin):
    ...
    validation = models.CharField(
        _("field validations"), choices=VALIDATION_CHOICES, max_length=100)
    error_message = models.CharField(
        _("error message"), default=_("Invalid entry"), max_length=100)
...
class ProjectAttribute(models.Model):
    ...
    languagecode = models.CharField(
        _('language'), max_length=10, choices=settings.LANGUAGES, null=True, blank=True)
